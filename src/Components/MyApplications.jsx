...
const MyApplications = () => {
  ...
  useEffect(() => {
    if (!loading && user.email) {
      // fetch(`https://job-portal-server-eight-bay.vercel.app/job-application?email=${user.email}`)
      //   .then((res) => res.json())
      //   .then((data) => setJobs(data));
      // axios.get(`https://job-portal-server-eight-bay.vercel.app/job-application?email=${user.email}`,{withCredentials:true})
